...
func (a *App) GetWorkspaceKindsHandler(w http.ResponseWriter, r *http.Request, _ httprouter.Params) { //nolint:dupl // TODO: Abstract common API patterns once implemented
